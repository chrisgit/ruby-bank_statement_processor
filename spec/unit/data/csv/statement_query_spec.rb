require 'spec_helper'
require 'support/data/query_category_data'
require 'support/data/query_date_data'
require 'support/data/query_type_data'

describe BankStatements::InMemoryQuery do
  describe '#query' do
    context 'transaction categories' do
      describe 'no category is specified' do
        it 'returns all data' do
          memory_query = BankStatements::InMemoryQuery.new(ALL_CATEGORY_DATA)
    ...
    context 'date ranges' do
      describe 'start and end is nil' do
        it 'returns all data' do
          memory_query = BankStatements::InMemoryQuery.new(ALL_DATE_DATA)
    ...
    context 'transaction types' do
      describe 'no type is specified' do
        it 'returns all data' do
          memory_query = BankStatements::InMemoryQuery.new(ALL_TYPE_DATA)
